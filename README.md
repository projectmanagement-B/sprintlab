...
* **Simulated Stakeholder Chat:** An interactive chat interface where users talk to "AI" stakeholders (Customer, Warehouse Operator, Manager) to gather requirements. *Note: Responses are scripted/regex-based for this MVP.*
